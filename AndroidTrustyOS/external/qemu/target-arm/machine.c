...
static const VMStateDescription vmstate_normal_world = {
    ...
    .minimum_version_id_old = 1,
    .fields = (VMStateField[]) {
        VMSTATE_UINT32(env.cp15.c2_base0.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_base0_hi.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_base1.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_base1_hi.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_control.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_mask.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_base_mask.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c3.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c5_insn.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c5_data.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c6_insn.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c6_data.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c7_par.normal, ARMCPU),
        VMSTATE_UINT32(env.cp15.c7_par_hi.normal, ARMCPU),
...
const VMStateDescription vmstate_arm_cpu = {
    ...
    .fields = (VMStateField[]) {
        ...
        VMSTATE_TIMER(gt_timer[GTIMER_PHYS_NS], ARMCPU),
        VMSTATE_TIMER(gt_timer[GTIMER_PHYS_S], ARMCPU),
